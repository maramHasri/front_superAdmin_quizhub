    ...
    <section className="rounded-2xl bg-white shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
              ...
              pageItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-slate-600">{ownerName}</td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className="h-9 rounded-lg border-slate-200 bg-white px-4 text-slate-700 hover:bg-slate-50"
                        >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 px-6 py-4">
        <p className="text-sm text-slate-400">
          {t("institutions.pagination.summary", {
